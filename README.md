...
OPC创业者联盟 — One Person Company Alliance
...
1. **构建镜像**
```bash
docker build -t opc-alliance .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name opc-alliance opc-alliance
```
...
- **项目主页**: https://github.com/MoKangMedical/opc-alliance
- **问题反馈**: https://github.com/MoKangMedical/opc-alliance/issues
